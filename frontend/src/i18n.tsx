...
const dict: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    close: "关闭",
    "settings.model": "对话模型",
    "settings.modelSub": "智能体用来回答问题的 LLM 服务（OpenAI 兼容）",
  ...
  en: {
    ...
    "settings.modelSub": "The LLM service (OpenAI-compatible) the assistant uses to answer",
    "settings.baseUrl": "Service URL (Base URL)",
    ...
    "settings.savedTip": "Model settings saved",
    newChat: "New chat",
    sessions: "Sessions",
